    ...
    <div className="px-5 pt-8 pb-32 md:pb-12 space-y-6 max-w-7xl mx-auto">
      ...
      <AnimatePresence>
        {showAddVidModal && isAdmin && (
          <div className="fixed inset-0 bg-stone-950/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4">
            <motion.div
              initial={{ scale: 0.95, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl p-6 border border-stone-200 relative scrollbar-thin"
