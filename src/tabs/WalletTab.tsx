...
const DIVIDEND_ESTIMATES: Record<string, { shareAmount: number; day: number }> = {
  // FIIs (proventos recorrentes baseados no histórico real)
  MXRF11: { shareAmount: 0.10, day: 15 },
  HGLG11: { shareAmount: 1.10, day: 14 },
  XPLG11: { shareAmount: 0.78, day: 15 },
  KNRI11: { shareAmount: 1.00, day: 15 },
  VISC11: { shareAmount: 0.85, day: 14 },
  HGRE11: { shareAmount: 0.95, day: 14 },
  XPML11: { shareAmount: 0.90, day: 20 },
  KNIP11: { shareAmount: 0.80, day: 13 },
  BTLG11: { shareAmount: 0.76, day: 25 },
  HGRU11: { shareAmount: 0.85, day: 15 },
  HGBS11: { shareAmount: 1.40, day: 15 },
  TRXF11: { shareAmount: 0.85, day: 15 },

  // Ações brasileiras populares (Dividendos recorrentes ou paridade estimada)
  PETR4: { shareAmount: 0.82, day: 20 },
  VALE3: { shareAmount: 1.35, day: 28 },
  ITUB4: { shareAmount: 0.24, day: 10 },
  BBAS3: { shareAmount: 0.45, day: 27 },
  BBDC4: { shareAmount: 0.19, day: 8 },
  WEGE3: { shareAmount: 0.28, day: 18 },
  ABEV3: { shareAmount: 0.15, day: 22 },
  B3SA3: { shareAmount: 0.18, day: 24 },
};
                ...
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-stone-500 mt-0.5 flex items-center gap-1">
                      ...
                      Previsto para dia {item.day} de {currentMonthName.substring(0, 3)}
                    </p>
                  </div>
                </div>
