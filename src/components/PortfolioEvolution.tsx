    ...
    <section className="relative rounded-3xl bg-gradient-to-br from-white via-white to-emerald-50/40 border border-stone-200 p-5 shadow-[0_4px_24px_-6px_rgba(16,185,129,0.12)] overflow-hidden animate-fade-in">
      ...
      <div className="relative">
        ...
        <div className="mt-5 flex gap-2">
          ...
          <div
            ref={containerRef}
            className="relative flex-1 touch-none select-none animate-fade-in"
            ...
            onTouchEnd={() => { isTouchingRef.current = false; setHoverIdx(null); }}
            onTouchCancel={() => { isTouchingRef.current = false; setHoverIdx(null); }}
          >
            <svg
